                    ...
                    <div class="form-row">
                        <div class="form-group col-half">
                            ...
                            <select id="presetSelect" class="form-control">
                                <option value="720p30" selected>720p 30fps (Recommended / Ultra-Smooth)</option>
                                <option value="720p60">720p 60fps (Smooth 60fps)</option>
                                <option value="1080p30">1080p 30fps (Full HD 30fps)</option>
                                <option value="1080p60">1080p 60fps (Full HD 60fps)</option>
                                <option value="passthrough">Passthrough (Copy Mode - 0% CPU)</option>
                            </select>
                        </div>
